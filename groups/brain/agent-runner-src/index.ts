        ...
        ...(containerInput.secrets?.GOOGLE_OAUTH_CLIENT_ID ? {
          'google-workspace': {
            ...
            env: {
              ...
              USER_GOOGLE_EMAIL: 'shapiro.jon@gmail.com',
              WORKSPACE_MCP_CREDENTIALS_DIR: '/workspace/extra/google-creds/personal',
            },
          },
          'google-workspace-imxp': {
            ...
            env: {
              GOOGLE_OAUTH_CLIENT_ID: containerInput.secrets.GOOGLE_OAUTH_CLIENT_ID,
              GOOGLE_OAUTH_CLIENT_SECRET: containerInput.secrets.GOOGLE_OAUTH_CLIENT_SECRET || '',
              USER_GOOGLE_EMAIL: 'jon@im-xp.com',
              WORKSPACE_MCP_CREDENTIALS_DIR: '/workspace/extra/google-creds/imxp',
              WORKSPACE_MCP_PORT: '8001',
            },
          },
        } : {}),
        // mcp-remote based servers (Fireflies, NocoDB) deferred:
        // mcp-remote may hang on OAuth in headless containers
      },
      hooks: {
